...
<?php endif; ?>
        ...
        <div class="mt-6 flex items-center justify-between gap-3">
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm text-muted underline hover:text-foreground" href="<?php echo e(route('password.request')); ?>">
                    Lupa kata sandi?
                </a>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\AdhijayaFC\resources\views/auth/login.blade.php ENDPATH**/ ?>