...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap items-end justify-between gap-3">
            <div>
                ...
                <p class="mt-1.5 text-sm text-muted"><?php echo e($service->name); ?></p>
            </div>
    ...
    <div class="max-w-2xl rounded-2xl border border-border bg-surface p-5 sm:p-6">
        <form method="POST" action="<?php echo e(route('admin.services.update', $service)); ?>">
            ...
            <?php echo $__env->make('admin.services.form', ['service' => $service, 'categories' => $categories, 'tiers' => $tiers], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\AdhijayaFC\resources\views/admin/services/edit.blade.php ENDPATH**/ ?>