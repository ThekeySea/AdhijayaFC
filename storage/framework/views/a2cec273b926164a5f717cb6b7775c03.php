...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-surface rounded-2xl overflow-hidden border border-border shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\laragon\www\AdhijayaFC\resources\views/components/modal.blade.php ENDPATH**/ ?>