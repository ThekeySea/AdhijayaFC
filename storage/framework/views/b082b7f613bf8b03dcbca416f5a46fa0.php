...
<?php endif; ?>
        ...
        <div class="mt-6 flex items-center justify-between gap-3">
            <a class="text-sm text-muted underline hover:text-foreground" href="<?php echo e(route('login')); ?>">
                Sudah punya akun?
            </a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\AdhijayaFC\resources\views/auth/register.blade.php ENDPATH**/ ?>