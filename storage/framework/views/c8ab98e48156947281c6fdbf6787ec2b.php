...
>
    <div class="mx-auto w-full max-w-lg px-2 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2">
        ...
        >
            ...
            <div class="flex min-w-0 flex-1 items-end gap-0.5">
                <?php $__currentLoopData = $leftItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a
                        ...
                        class="flex min-h-14 min-w-0 flex-1 flex-col items-center justify-center gap-1 rounded-2xl px-1 py-2 transition <?php echo e($item['active'] ? 'bg-primary-soft text-primary ring-1 ring-inset ring-primary/25' : 'text-slate-700 hover:bg-background hover:text-foreground'); ?>"
                    ...
                    >
                        ...
                        <span class="text-[11px] font-bold leading-none tracking-tight"><?php echo e($item['label']); ?></span>
                    </a>
            ...
            <a
                href="<?php echo e($printUrl); ?>"
                class="relative -mt-7 flex h-16 w-16 shrink-0 flex-col items-center justify-center gap-1 rounded-2xl border-2 border-white/90 bg-primary text-white shadow-[0_12px_24px_-8px_rgba(37,99,235,0.6),inset_0_1px_0_rgba(255,255,255,0.3)] transition hover:bg-primary-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary <?php echo e($printActive ? 'ring-2 ring-primary/40 ring-offset-2 ring-offset-surface' : 'ring-1 ring-primary/20'); ?>"
                <?php if($printActive): ?> aria-current="page" <?php endif; ?>
            >
                ...
                <span class="text-[11px] leading-none tracking-tight transition <?php echo e($printActive ? 'font-extrabold [text-shadow:0_0_8px_rgba(255,255,255,0.85),0_0_16px_rgba(255,255,255,0.45)]' : 'font-semibold'); ?>">Print</span>
            </a>
            ...
            <div class="flex min-w-0 flex-1 items-end gap-0.5">
                <?php $__currentLoopData = $rightItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a
                        href="<?php echo e($item['href']); ?>"
                        class="relative flex min-h-14 min-w-0 flex-1 flex-col items-center justify-center gap-1 rounded-2xl px-1 py-2 transition <?php echo e($item['active'] ? 'bg-primary-soft text-primary ring-1 ring-inset ring-primary/25' : 'text-slate-700 hover:bg-background hover:text-foreground'); ?>"
                        <?php if($item['active']): ?> aria-current="page" <?php endif; ?>
                    >
                        <span class="relative">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" aria-hidden="true">
...
<?php /**PATH C:\laragon\www\AdhijayaFC\resources\views/components/bottom-nav.blade.php ENDPATH**/ ?>